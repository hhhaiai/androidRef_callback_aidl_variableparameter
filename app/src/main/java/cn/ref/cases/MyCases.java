...
public class MyCases {
    ...
    private  static ClassLoader getClassLoader(){
       return MyCases.class.getClassLoader();
    }

    /**
     * 常规回调函数
     */
    public static  void generalCallBack() {
...
/***************************************************************************************/
     ...
     * 发射调用
     */
    public static  void refOho() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException, InstantiationException, NoSuchMethodException {
        //
